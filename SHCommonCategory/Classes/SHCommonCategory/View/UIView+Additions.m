...
//  jkcarddemo
//
//  Created by Dreamhigh66 on 4/17/14.
...
+ (void)registerNibForCellToCollectionView:(UICollectionView *)collectionView
{
    [collectionView registerNib:[self nib] forCellWithReuseIdentifier:[self reuseIdentifier]];
}
