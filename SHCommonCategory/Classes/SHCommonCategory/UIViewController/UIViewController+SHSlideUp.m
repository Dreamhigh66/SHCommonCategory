...
#import "UIViewController+SHSlideUp.h"
#import <QuartzCore/QuartzCore.h>

@interface UIViewController(SHSlideUpInternal)
-(UIView*)parentTarget;
-(CAAnimationGroup*)animationGroupForward:(BOOL)_forward;
@end


@implementation UIViewController (SHSlideUpInternal)
-(UIView*)parentTarget {
...
@implementation UIViewController (SHSemiModal)
